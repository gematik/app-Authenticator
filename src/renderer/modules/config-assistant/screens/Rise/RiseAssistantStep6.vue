...
<template>
  <div>
    ...
    <div class="text-center text-base">
      <ul class="flex flex-wrap mb-2">
        <li class="me-2">
          ...
          >
            {{ $t('config_assistant.rise.step6.server_client_cert_auth') }}
          </a>
        </li>
        <li class="me-2">
          <a
          ...
          >
            {{ $t('config_assistant.rise.step6.pfx') }}
          </a>
        </li>
        <li class="me-2">
          <a
          ...
          >
            {{ $t('config_assistant.rise.step6.basic_auth') }}
          </a>
        </li>
        <li class="me-2">
          <a
          ...
          >
            {{ $t('config_assistant.rise.step6.no_auth') }}
          </a>
        </li>
      </ul>
    </div>
        ...
        <div class="flex flex-row mb-8">
          <div class="w-2/3">
            <ol class="list-decimal list-outside ml-4">
              <li class="list-item mt-1">{{ $t('config_assistant.rise.step6.server_client_cert_auth_step1') }}</li>
              <li class="list-item mt-2">{{ $t('config_assistant.rise.step6.server_client_cert_auth_step2') }}</li>
              <li class="list-item mt-2">{{ $t('config_assistant.rise.step6.server_client_cert_auth_step3') }}</li>
              <li class="list-item mt-2">{{ $t('config_assistant.rise.step6.server_client_cert_auth_step4') }}</li>
              <li class="list-item mt-2">{{ $t('config_assistant.rise.step6.server_client_cert_auth_step6') }}</li>
            </ol>
          </div>
          <div class="flex flex-col gap-4">
            <ScreenshotHelper
              image-src="rise_step6_cert.png"
              :image-description="$t('config_assistant.rise.step6.screen_hint')"
            />
            <AssistantButton
              button-link="https://wiki.gematik.de/download/attachments/540043222/Authenticator_Tutorial_rise.mp4"
            />
          </div>
        </div>
        <AssistantInput
    ...
    <div v-if="activeTab === TLS_AUTH_TYPE.ServerClientCertAuth_Pfx" class="p-0 max-w-screen-md max-h-96">
      <p>{{ $t('config_assistant.rise.step6.pfx') }}</p>
      <AssistantInput
    ...
    <div v-if="activeTab === TLS_AUTH_TYPE.BasicAuth" class="p-0 max-w-screen-md max-h-96 mt-2">
      <p class="mb-4">
        {{ $t('config_assistant.rise.step6.basic_auth_hint') }}
      </p>
      <hr />
    ...
    <div v-if="activeTab === TLS_AUTH_TYPE.ServerCertAuth" class="p-0 max-w-screen-md max-h-96 mt-2">
      <p>
        {{ $t('config_assistant.rise.step6.no_auth_hint') }}
      </p>
    </div>
  </div>
</template>
