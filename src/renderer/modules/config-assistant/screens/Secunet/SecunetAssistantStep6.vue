...
<template>
  <div class="m-4">
    ...
    <div class="flex flex-row mt-12 mb-8">
      <div class="w-2/3">
        <p>
          <strong>{{ $t('config_assistant.secunet.step6.intro') }}</strong>
        </p>
        <ol class="list-decimal list-outside ml-4">
          <li class="list-item mt-2">{{ $t('config_assistant.secunet.step6.workplaceId_step1') }}</li>
          <li class="list-item mt-2">{{ $t('config_assistant.secunet.step6.workplaceId_step2') }}</li>
          <li class="list-item mt-2">{{ $t('config_assistant.secunet.step6.workplaceId_step3') }}</li>
          <li class="list-item mt-2">{{ $t('config_assistant.secunet.step6.workplaceId_step4') }}</li>
          <li class="list-item mt-2">{{ $t('config_assistant.secunet.step6.workplaceId_step5') }}</li>
        </ol>
      </div>
      <div class="flex flex-col justify-start items-end gap-4 w-1/3">
        <ScreenshotHelper
          image-src="secu_step5_arbeitsplatz.png"
    ...
    <AssistantInput
      ...
      :label="$t('config_assistant.secunet.step6.title')"
      type="text"
      :maxlength="50"
