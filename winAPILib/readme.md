...
WinAPILib is a .NET library that retrieves certificates from specified Windows certificate stores and
...
Currently, we ship a signed DLL from our repository, but it is not build automatically. If you need to rebuild the DLL, please ensure it is signed with our signer certificate in Jenkins.
