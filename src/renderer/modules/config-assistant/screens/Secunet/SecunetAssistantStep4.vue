...
<template>
  <div>
    ...
    <div class="flex flex-row mb-8">
      <div class="w-2/3">
        <p>
          <strong>{{ $t('config_assistant.secunet.step4.intro') }}</strong>
        </p>
        <ol class="list-decimal list-outside ml-4">
          <li class="list-item mt-4">{{ $t('config_assistant.secunet.step4.mandantId_step1') }}</li>
          <li class="list-item mt-4">{{ $t('config_assistant.secunet.step4.mandantId_step2') }}</li>
          <li class="list-item mt-4">{{ $t('config_assistant.secunet.step4.mandantId_step3') }}</li>
          <li class="list-item mt-4">{{ $t('config_assistant.secunet.step4.mandantId_step4') }}</li>
          <li class="list-item mt-4">{{ $t('config_assistant.secunet.step4.mandantId_step5') }}</li>
        </ol>
      </div>
      <div class="flex flex-col gap-4">
        <ScreenshotHelper
          image-src="secu_step4_mandant.png"
          :image-description="$t('config_assistant.secunet.step4.screen_hint')"
        />
      </div>
    </div>
    <AssistantInput
