    ...
    <div class="flex flex-row mt-12">
      <div class="w-2/3">
        <p class="mb-1 flex flex-row justify-between">
          <strong>{{ $t('config_assistant.rise.step4.clientId_heading') }}</strong>
        </p>
        <ol class="list-decimal list-inside mb-4">
          <li class="list-item mt-2">{{ $t('config_assistant.rise.step4.clientId_step1') }}</li>
          <li class="list-item mt-2">{{ $t('config_assistant.rise.step4.clientId_step2') }}</li>
          <li class="list-item mt-2">{{ $t('config_assistant.rise.step4.clientId_step3') }}</li>
          <li class="list-item mt-2">
            {{ $t('config_assistant.rise.step4.clientId_step4') }}
          </li>
        </ol>
      </div>
      <div class="flex flex-col justify-start items-end gap-4 w-1/3">
        <ScreenshotHelper
          ...
          :image-description="$t('config_assistant.rise.step4.clientId_screenshot_hint')"
        />
      </div>
    </div>
    <div>
