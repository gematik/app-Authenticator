  ...
  <div>
    ...
    <div class="m-4" v-if="props.repositoryData[TLS_AUTH_TYPE_CONFIG] == TLS_AUTH_TYPE.BasicAuth">
      <div class="assistant-heading flex flex-row justify-between">
        {{ $t('config_assistant.secunet.step9.BasicAuth.title') }}
        <AssistantButton
          button-link="https://wiki.gematik.de/download/attachments/540043222/Authenticator_Tutorial_Rise_small.mp4"
        />
      </div>
      <div class="flex felx-row mb-8">
        <div class="w-2/3">
          <strong> {{ $t('config_assistant.secunet.step9.BasicAuth.title') }}</strong>
          <p class="mb-4 mt-2 flex flex-row justify-between">
            {{ $t('config_assistant.secunet.step9.BasicAuth.basic_auth_hint') }}
          </p>
        </div>
    ...
    <div class="m-4" v-if="props.repositoryData[TLS_AUTH_TYPE_CONFIG] == TLS_AUTH_TYPE.ServerClientCertAuth">
      <div class="assistant-heading flex flex-row justify-between">
        {{ $t('config_assistant.secunet.step9.ServerClientCertAuth.title') }}
        <AssistantButton
          button-link="https://wiki.gematik.de/download/attachments/540043222/Authenticator_Tutorial_Rise_small.mp4"
        />
      </div>
      <div class="flex flex-row mt-8">
        <div class="w-2/3">
          <p class="mb-1 flex flex-row justify-between">
            <strong>{{ $t('config_assistant.secunet.step9.ServerClientCertAuth.intro') }}</strong>
          </p>
          <ol class="list-decimal list-outside ml-4">
            <li class="list-item mt-2">
              {{ $t('config_assistant.secunet.step9.ServerClientCertAuth.server_client_cert_auth_step1') }}
            </li>
            <li class="list-item mt-2">
              {{ $t('config_assistant.secunet.step9.ServerClientCertAuth.server_client_cert_auth_step2') }}
            </li>
            <li class="list-item mt-2">
              {{ $t('config_assistant.secunet.step9.ServerClientCertAuth.server_client_cert_auth_step3') }}
            </li>
            <li class="list-item mt-2">
              {{ $t('config_assistant.secunet.step9.ServerClientCertAuth.server_client_cert_auth_step4') }}
            </li>
            <li class="list-item mt-2">
              {{ $t('config_assistant.secunet.step9.ServerClientCertAuth.server_client_cert_auth_step5') }}
            </li>
            <li class="list-item mt-2">
              {{ $t('config_assistant.secunet.step9.ServerClientCertAuth.server_client_cert_auth_step6') }}
            </li>
          </ol>
        </div>
        <div class="flex flex-col justify-start items-end gap-4 w-1/3">
    ...
    <div class="m-4" v-if="props.repositoryData[TLS_AUTH_TYPE_CONFIG] == TLS_AUTH_TYPE.ServerClientCertAuth_Pfx">
      <div class="assistant-heading flex flex-row justify-between">
        {{ $t('config_assistant.secunet.step9.ServerClientCertAuth_Pfx.title') }}
        <AssistantButton
          button-link="https://wiki.gematik.de/download/attachments/540043222/Authenticator_Tutorial_Rise_small.mp4"
        />
      </div>
      <div>
        <strong>{{ $t('config_assistant.secunet.step9.ServerClientCertAuth_Pfx.pfx') }}</strong>
        <p class="mb-1 mt-2">
          {{ $t('config_assistant.secunet.step9.ServerClientCertAuth_Pfx.pfx_hint') }}
        </p>
      </div>
      <div class="mt-4">
        <AssistantInput
    ...
    <div class="m-4" v-if="props.repositoryData[TLS_AUTH_TYPE_CONFIG] == TLS_AUTH_TYPE.ServerCertAuth">
      <div class="assistant-heading flex flex-row justify-between">
        {{ $t('config_assistant.secunet.step9.ServerCertAuth.step_title') }}
      </div>
      ...
      <div class="mt-4 bg-orange-100 border-l-4 border-orange-500 text-orange-700 p-4" role="alert">
        ...
        <p>{{ $t('config_assistant.secunet.step9.ServerCertAuth.no_authentication_text') }}</p>
      </div>
      <div class="mt-4">
        <p>{{ $t('config_assistant.secunet.step9.ServerCertAuth.no_authentication_back') }}</p>
      </div>
    </div>
  </div>
</template>
...
const basicAuthScreenshots = [
  'secunet_step9_user_pw_part1.png',
  'secunet_step9_user_pw_part2.png',
  'secunet_step9_user_pw_part3.png',
  'secunet_step9_user_pw_part4.png',
];
const basicAuthScreenshotsDescription = [
  translate('config_assistant.secunet.step9.BasicAuth.basicAuth_screen_hint1'),
  translate('config_assistant.secunet.step9.BasicAuth.basicAuth_screen_hint2'),
  translate('config_assistant.secunet.step9.BasicAuth.basicAuth_screen_hint3'),
  translate('config_assistant.secunet.step9.BasicAuth.basicAuth_screen_hint4'),
];

const certScreenshots = [
  'secunet_step10_cert_part1.png',
  'secunet_step10_cert_part2.png',
  'secunet_step10_cert_part3.png',
  'secunet_step10_cert_part4.png',
];
const certScreenshotsDescription = [
  translate('config_assistant.secunet.step9.ServerClientCertAuth.server_client_cert_auth_screen_hint1'),
  translate('config_assistant.secunet.step9.ServerClientCertAuth.server_client_cert_auth_screen_hint2'),
  translate('config_assistant.secunet.step9.ServerClientCertAuth.server_client_cert_auth_screen_hint3'),
  translate('config_assistant.secunet.step9.ServerClientCertAuth.server_client_cert_auth_screen_hint4'),
];
</script>
