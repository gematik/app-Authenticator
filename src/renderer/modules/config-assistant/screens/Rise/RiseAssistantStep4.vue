...
<template>
  <div>
    <div class="assistant-heading flex flex-row justify-between">
      {{ $t('config_assistant.rise.step4.title') }}
      <AssistantButton
    ...
    <div class="flex flex-row mb-8">
      <div class="w-2/3">
        <p>
          <strong>{{ $t('config_assistant.rise.step4.intro') }}</strong>
        </p>
        <ol class="list-decimal list-outside ml-4">
          <li class="list-item mt-4">{{ $t('config_assistant.rise.step4.mandantId_step1') }}</li>
          <li class="list-item mt-4">{{ $t('config_assistant.rise.step4.mandantId_step2') }}</li>
          <li class="list-item mt-4">{{ $t('config_assistant.rise.step4.mandantId_step3') }}</li>
          <li class="list-item mt-4">{{ $t('config_assistant.rise.step4.mandantId_step4') }}</li>
        </ol>
      </div>
      <div class="flex flex-col gap-4">
        <ScreenshotHelper
          image-src="rise_step4and5_mandant_workplace.png"
          :image-description="$t('config_assistant.rise.step4.screen_hint')"
        />
      </div>
    </div>
    <AssistantInput
      v-model="props.repositoryData[CONTEXT_PARAMETERS_CONFIG_GROUP.MANDANT_ID]"
      :label="$t('config_assistant.rise.step4.title')"
      type="text"
      :maxlength="50"
