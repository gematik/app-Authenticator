...
<template>
  <div class="m-4">
    ...
    <div class="flex flex-row mb-8">
      <div class="w-2/3">
        <p>
          <strong>{{ $t('config_assistant.koco.step6.intro') }}</strong>
        </p>
        <ol class="list-decimal list-outside ml-4">
          <li class="list-item mt-2">{{ $t('config_assistant.koco.step6.workplaceId_step1') }}</li>
          <li class="list-item mt-2">{{ $t('config_assistant.koco.step6.workplaceId_step2') }}</li>
          <li class="list-item mt-2">{{ $t('config_assistant.koco.step6.workplaceId_step3') }}</li>
          <li class="list-item mt-2">{{ $t('config_assistant.koco.step6.workplaceId_step4') }}</li>
        </ol>
      </div>
      <div class="flex flex-col justify-start items-end gap-4 w-1/3">
        <ScreenshotHelper
          image-src="koco_step5_arbeitsplatz.png"
          :image-description="$t('config_assistant.koco.step6.screen_hint')"
        />
      </div>
    </div>
    <AssistantInput
      ...
      :label="$t('config_assistant.koco.step6.title')"
      type="text"
      :maxlength="50"
