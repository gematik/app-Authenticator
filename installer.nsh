...
!macro customInstall
  ...
  ; Remove deprecated/obsolete certificates (silent, no error if missing)
  Delete "$INSTDIR\resources\certs-konnektor\AUTH.GEM.KOMP-CA1.pem"
  Delete "$INSTDIR\resources\certs-konnektor\AUTH.GEM.KOMP-CA3.pem"
  Delete "$INSTDIR\resources\certs-konnektor\AUTH.GEM.KOMP-CA5.pem"
  Delete "$INSTDIR\resources\certs-konnektor\AUTH.GEM.KOMP-CA7.pem"
  Delete "$INSTDIR\resources\certs-konnektor\GEM.KOMP-CA3.pem"
  Delete "$INSTDIR\resources\certs-konnektor\GEM.RCA2-CROSS-GEM.RCA3.pem"
  Delete "$INSTDIR\resources\certs-konnektor\GEM.RCA2-CROSS-GEM.RCA6.pem"
  Delete "$INSTDIR\resources\certs-konnektor\GEM.RCA5-CROSS-GEM.RCA6.pem"
  Delete "$INSTDIR\resources\certs-konnektor\GEM.RCA6-CROSS-GEM.RCA2.pem"
  ...
  Delete "$INSTDIR\resources\certs-konnektor\GEM.RCA.NIST.BUNDLE.crt"
