...
<template>
  <div class="m-4">
    <div class="assistant-heading flex flex-row justify-between">
      {{ $t('config_assistant.koco.step11.title') }}
      <AssistantButton
    ...
    <div class="assistant-section mb-5">
      ...
      <p
        ...
        v-html="$t('config_assistant.koco.step11.description_text_activated')"
      ></p>
      <p
        class="mb-1"
        :style="{ marginTop: '20px' }"
        v-html="$t('config_assistant.koco.step11.description_text_deactivated')"
      ></p>
      <AssistantToggle v-model="props.repositoryData[ENTRY_OPTIONS_CONFIG_GROUP.WARN_CARD_EXPIRATION]" />
      <p class="mb-1" :style="{ marginTop: '20px' }" v-html="$t('config_assistant.koco.step11.hint')"></p>
    </div>
  </div>
</template>
